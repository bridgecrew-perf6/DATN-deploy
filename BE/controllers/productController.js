...
const createProduct = asyncHandler(async (req, res) => {
  ...
  const product = Product.create({
    ...
    linkVideo: req.body.linkVideo ? req.body.linkVideo : ''
  });
...
const updateProduct = asyncHandler(async (req, res) => {
  const { name, price, description, weight, dimensions, categoryId, countInStock, discount, linkVideo } =
    req.body;
  const files = req.files
  ...
  if (product) {
    ...
    product.linkVideo = linkVideo || product.linkVideo;
